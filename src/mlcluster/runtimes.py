...
from mlcluster.utils import ExecutionFileLogUtil
...
class RuntimeTask(object):
    ...
    def _execute_run_command_step(
        ...
        if debug:
            ...
            raise MlclusterError("ExecutionFileLogUtil.file_path is not defined")
...
class Runtime(object):
    ...
    def os(self) -> str:
        ...
        if not isinstance(self._info["os"], str):
            raise MlclusterError("Runtime._info['os'] must be of type str")
    ...
    def cpu_cores(self) -> int:
        ...
        Raises:
            MlclusterError: Data could not be read succesfully.
        ...
        if not isinstance(self._info["cpu_cores"], str):
            raise MlclusterError("Runtime._info['cpu_cores'] must be of type str")
    ...
    def memory(self) -> int:
        ...
        if not isinstance(self._info["memory"], str):
            raise MlclusterError("Runtime._info['memory'] must be of type str")
    ...
    def gpus(self) -> List[str]:
        ...
        if not isinstance(self._info["gpus"], list):
            raise MlclusterError("Runtime._info['gpus'] must be of type List")
    ...
    def _create_working_dir_if_not_exists(self) -> None:
        ...
        if not self._working_dir:
            raise MlclusterError("Working Directory could not be created")
