...
class MlclusterError(Exception):
...
class TaskExecutionError(MlclusterError):
...
class InvalidRuntimeError(MlclusterError):
...
class NoRuntimesDetectedError(MlclusterError):
...
class PortInUseError(MlclusterError):
...
class NoPortsLeftError(MlclusterError):
...
class PathCreationError(MlclusterError):
